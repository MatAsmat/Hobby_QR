            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- <a class="btn btn-secondary btn-sm" href="../file/code_board.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a> -->
                        <a class="float-right btn btn-success btn-sm" href="./create_type_ctag.php">
                    ...
                    <div class="card-body">
                    <?php
                            $query = "SELECT * FROM tbl_cat_breed ORDER BY CatBreedID asc" or die("Error:" . mysqli_error());
                                ...
                                echo "<table  id='example1' class='table table-bordered table-striped'>";
                                    ...
                                    $item = 0;
                                        while($row = mysqli_fetch_array($result)) { 
                                            ...
                                            echo "<td align='center'>" .'TY_DT'.$row["CatBreedID"] . "</td> "; 
                                            echo "<td>" .$row["CatBreedName"] .  "</td> "; 
                                            echo "<td>" .$row["CatBreedCare"] .  "</td> "; 
                                            //แก้ไขข้อมูล
                                            echo "<td class='project-actions text-center'>
                                            <a href='update_type_ctag.php?ID=$row[0]' class='btn btn-info btn-sm'> <i class='fas fa-pencil-alt'>
                                            </i> แก้ไข</a></td> ";
