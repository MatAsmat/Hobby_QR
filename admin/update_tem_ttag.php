...
INNER JOIN tbl_tree_breed as b ON t.Ref_BreedID=b.TreeBreedID
...
WHERE TreeBreedID!=$Ref_BreedID" or die("Error:" . mysqli_error());
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">แก้ไขข้อมูลนามบัตรต้นไม้<h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">แก้ไขข้อมูลนามบัตรต้นไม้</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <a class="float-right btn btn-dark btn-sm" href="./table_pro_ttag.php">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form role="form" action="update_tem_ttag_db.php" method="post" name="form1"  onsubmit="return checkForm();" class="form-horizontal" enctype="multipart/form-data">
                        <div class="row">
                        <div class="col-sm-2">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="Ref_BreedID" class="form-control">
                                        <option value="<?php echo $row['Ref_BreedID'];?>">-<?php echo $row['TreeBreedName'];?>-
                                        </option>
                                        <option value="">--เลือกข้อมูล--</option>
                                        <?php foreach($result2 as $results2){ ?>
                                        <option value="<?php echo $results2["TreeBreedID"];?>">
                                            - <?php echo $results2["TreeBreedName"];?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>
                ...
                <div class="card-footer">
                    <div class="float-right">
                        ...
                        <input type="hidden" name="TemplateCategory" value="TTag">
