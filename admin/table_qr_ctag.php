            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- <a class="btn btn-secondary btn-sm" href="../file/code_board.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a> -->
                        <a class="float-right btn btn-success btn-sm" href="./create_qr_ctag.php">
                    ...
                    <div class="card-body">
                            ...
                            WHERE ProductCategory = 'CTag' ORDER BY QrCodeID DESC" or die("Error:" . mysqli_error());
                            $result = mysqli_query($condb, $query); 
                                echo "<table  id='example1' class='table table-bordered table-striped'>";
                                    ...
                                    while($row = mysqli_fetch_array($result)) { 
                                        ...
                                        echo "<td align='center'>"."<img class='table-avatar' width='150px' alt='image' src='https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=https://hobbyqr.com/member/ctag_register.php?qrID=".$row['QrCodeName']."'>"."</td>";
...
$(document).ready(function() {
    ...
    $('a[href^="./table_qr_ctag.php"]').addClass('nav-item has-treeview menu-open nav-link active');
