                            ...
                            $result = mysqli_query($condb, $query); 
                                echo "<table  id='example1' class='table table-bordered table-striped'>";
                                    ...
                                    while($row = mysqli_fetch_array($result)) { 
                                        ...
                                        echo "<td align='center'>"."<img class='table-avatar' width='150px' alt='image' src='https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=https://test.matterdevs.com/member/ctag_register.php?qrID=".$row['QrCodeName']."'>"."</td>";
