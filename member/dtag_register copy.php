                    ...
                    <form role="form" action="dtag_register_db.php" method="post" name="form1" class="appointment" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <label>* รูปโปรไฟล์สุนัข</label>
                                <div class="form-group">
                                    <input type="file" name="DogPhoto" id="upload_image" class="form-control" placeholder="* รูป (Photo)" eccept="image/*" required>
                                    <br>
                            ...
                            <label>* กรุ๊ปเลือด</label>
                                <div class="form-group">
                                    <div class="form-field">
                                        <div class="select-wrap">
                                            <div class="icon"><span class="fa fa-chevron-down"></span></div>
                                            <select name="DogBlood" id="" class="form-control" required>
